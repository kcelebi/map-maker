int im_x = 4500; //DIMENSIONS OF YOUR MAP, CHANGE IT ACCORDING TO YOUR IMAGE SIZE
int im_y = 2234; //DIMENSIONS OF YOUR MAP, CHANGE IT ACCORDING TO YOUR IMAGE SIZE
